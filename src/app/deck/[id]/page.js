    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-background p-6">
        <div className="border-4 border-black bg-white p-8 shadow-[8px_8px_0px_0px_black] text-center">
          ...
          <Link href="/" className="inline-block px-6 py-3 bg-black text-white font-bold uppercase tracking-wider hover:bg-gray-800 transition-colors">Return to Dashboard</Link>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-background p-6 md:p-12 font-sans flex flex-col selection:bg-primary-yellow">
      <div className="max-w-4xl mx-auto w-full flex-1 flex flex-col">
        ...
        <div className="flex items-center justify-between mb-8 border-b-4 border-black pb-4">
          <Link href="/" className="inline-flex items-center text-sm font-bold uppercase tracking-widest text-black hover:text-primary-red transition-colors">
